...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        activeStatus: json["active_status"].toString().toInt(),
        ...
        parentId: json["parent_id"].toString().toInt(),
        userId: json["user_id"].toString().toInt(),
        roleId: json["role_id"].toString().toInt(),
        genderId: json["gender_id"].toString().toInt(),
...
class ParentUser {
  ...
  factory ParentUser.fromJson(Map<String, dynamic> json) => ParentUser(
        ...
        styleId: json["style_id"].toString().toInt(),
        rtlLtl: json["rtl_ltl"].toString().toInt(),
        selectedSession: json["selected_session"].toString().toInt(),
        createdBy: json["created_by"].toString().toInt(),
        updatedBy: json["updated_by"].toString().toInt(),
        accessStatus: json["access_status"].toString().toInt(),
        schoolId: json["school_id"].toString().toInt(),
        roleId: json["role_id"].toString().toInt(),
        isAdministrator: json["is_administrator"],
        isRegistered: json["is_registered"].toString().toInt(),
        ...
        walletBalance: json["wallet_balance"].toString().toDouble(),
...
class StudentRecord {
  ...
  factory StudentRecord.fromJson(Map<String, dynamic> json) => StudentRecord(
        ...
        sectionId: json["section_id"].toString().toInt(),
        rollNo: json["roll_no"].toString(),
        isPromote: json["is_promote"].toString().toInt(),
        sessionId: json["session_id"].toString().toInt(),
        schoolId: json["school_id"].toString().toInt(),
        academicId: json["academic_id"].toString().toInt(),
        studentId: json["student_id"].toString().toInt(),
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        isDefault: json["is_default"].toString().toInt(),
      );
