...
class ClassRoutine {
    ...
    factory ClassRoutine.fromJson(Map<String, dynamic> json) => ClassRoutine(
        id: json["id"],
        day: json["day"].toString().toInt(),
        activeStatus: json["active_status"].toString().toInt(),
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        roomId: json["room_id"].toString().toInt(),
        teacherId: json["teacher_id"].toString().toInt(),
        classPeriodId: json["class_period_id"],
        subjectId: json["subject_id"].toString().toInt(),
...
class Room {
    ...
    factory Room.fromJson(Map<String, dynamic> json) => Room(
        id: json["id"],
        roomNo: json["room_no"],
        capacity: json["capacity"].toString().toInt(),
        activeStatus: json["active_status"].toString().toInt(),
        createdAt: DateTime.parse(json["created_at"]),
        updatedAt: DateTime.parse(json["updated_at"]),
        createdBy: json["created_by"].toString().toInt(),
...
class SmWeekend {
    ...
    factory SmWeekend.fromJson(Map<String, dynamic> json) => SmWeekend(
        id: json["id"],
        name: json["name"],
        order: json["order"].toString().toInt(),
        isWeekend: json["is_weekend"].toString().toInt(),
    );
