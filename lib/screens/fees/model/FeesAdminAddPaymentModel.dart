...
class FeesAdminAddPaymentModel {
  ...
  factory FeesAdminAddPaymentModel.fromJson(Map<String, dynamic> json) =>
      FeesAdminAddPaymentModel(
        ...
        walletBalance: json["walletBalance"].toString().toDouble(),
      );
...
class InvoiceDetail {
  ...
  factory InvoiceDetail.fromJson(Map<String, dynamic> json) => InvoiceDetail(
        ...
        amount: json["amount"] == null ? 0.0 : json["amount"].toString().toDouble(),
        weaver: json["weaver"] == null ? 0.0 : json["weaver"].toString().toDouble(),
        fine: json["fine"] == null ? 0.0 : json["fine"].toString().toDouble(),
        subTotal:
            json["sub_total"] == null ? 0.0 : json["sub_total"].toString().toDouble(),
        paidAmount:
            json["paid_amount"] == null ? 0.0 : json["paid_amount"].toString().toDouble(),
        dueAmount:
            json["due_amount"] == null ? 0.0 : json["due_amount"].toString().toDouble(),
