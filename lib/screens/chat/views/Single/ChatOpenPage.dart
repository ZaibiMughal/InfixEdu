                        ...
                        LoadingMoreList<ChatMessage>(
                          ListConfig<ChatMessage>(
                            ...
                            itemBuilder: (BuildContext c,
                              ...
                              // print("chatMessage.messageType ${chatMessage.message}");
                              // if(chatMessage.messageType == "1"){
                              //   print(chatMessage.fileName);
                              //   return Container();
                              // }
                              return MessageItemWidget(
                                  ...
                                  menuVisible: false,
                                  showActions: true,
                                  activeStatus: int.parse(_chatOpenController
                                      .activeUser.value.activeStatus.toString()),
                                  onTapMenu: () {
                                    onMenuPress(
                                      context: context,
                                      showActions: false,
                  ...
                  Container(
                    ...
                    child: Obx(() {
                      if (_chatOpenController.isLoading.value) {
                        ...
                        // print("_chatOpenController.activeUser ${_chatOpenController.activeUser.value}");
                        if (_chatOpenController.activeUser.value.block == null ? true : _chatOpenController.activeUser.value.block && false) {
                          return const SizedBox.shrink();
                        } else {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      MessageItemWidget(
                        ...
                        activeStatus:
                        int.parse(_chatOpenController.activeUser.value.activeStatus),
                      ),
                      Padding(
                        padding:
        ...
        child: Column(
          ...
          children: <Widget>[
            MessageItemWidget(
              ...
              menuVisible: menuVisible,
              showActions: showActions,
              activeStatus: int.parse(_chatOpenController.activeUser.value.activeStatus),
            ),
            Container(
                ...
                children: <Widget>[
                  ...
                  Obx(() {
                    if (_chatOpenController.isLoading.value) {
                      ...
                      if (_chatOpenController.activeUser.value.block == null ? true : _chatOpenController.activeUser.value.block) {
